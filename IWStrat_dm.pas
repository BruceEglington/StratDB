...
type
  TdmStrat = class(TDataModule)
    ...
    qContinentsLANGUAGEID: TWideStringField;
    qContinentsHASDATA: TWideStringField;
...
uses
  IWInit,
  IWStrat_constants,
  Variants, UserSessionUnit, ServerController, usrIW_dm;
...
begin
    ...
    begin
      ...
      //cdsQuery1Rec.Close;
      //Query1Rec.SQL.Clear;
      //Query1Rec.SQL.Add('SELECT COUNT;
