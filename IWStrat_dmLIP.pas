...
type
  TdmLIP = class(TDataModule)
    ...
    LIPQueryLIPNAME: TWideStringField;
    LIPQueryLIPNAMELIPID: TWideStringField;
    LIPQueryCONTINENTID: TWideStringField;
    LIPQueryCONTOCEANID: TWideStringField;
    LIPQueryPLOTBARCODE: TWideStringField;
    LIPQueryLIPSIZEDESCRIPTION: TWideStringField;
    cdsLIPQueryLIPNAME: TWideStringField;
    cdsLIPQueryLIPNAMELIPID: TWideStringField;
    cdsLIPQueryCONTINENTID: TWideStringField;
    cdsLIPQueryCONTOCEANID: TWideStringField;
    cdsLIPQueryPLOTBARCODE: TWideStringField;
    cdsLIPQueryLIPSIZEDESCRIPTION: TWideStringField;
    qLIPMapMAPID2: TWideStringField;
    qLIPMapGISSTR: TWideStringField;
    qLIPMapMAPNAME: TWideStringField;
    cdsLipQqLIPMap: TDataSetField;
    cdsLIPMapMAPID2: TWideStringField;
    cdsLIPMapGISSTR: TWideStringField;
    cdsLIPMapMAPNAME: TWideStringField;
...
function dmLIP: TdmLIP;
begin
  Result := TIWUserSession(WebApplication.Data).dmLIP;
end;
