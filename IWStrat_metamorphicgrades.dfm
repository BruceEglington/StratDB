object ISFMetamorphicGrades: TISFMetamorphicGrades
  Left = 0
  Top = 0
  Width = 687
  Height = 598
  ...
  object iwDBg: TIWDBGrid
    ...
    DataSource = dmStratC.dsMetamorphicGrade
    FooterRowCount = 0
    FriendlyName = 'iwDBg'
    FromStart = False
  ...
  object FDMemTable1: TFDMemTable
    ...
    Left = 544
    Top = 64
    object FDMemTable1GradeID: TStringField
      FieldName = 'GradeID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Size = 1
    end
    object FDMemTable1Grade: TStringField
      FieldName = 'Grade'
      Size = 50
    end
  end
