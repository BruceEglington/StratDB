object ISFSedEnv: TISFSedEnv
  ...
  object iwDBg: TIWDBGrid
    ...
    Columns = <
      ...
      item
        ...
        BlobCharLimit = 0
        CompareHighlight = hcNone
        DataField = 'DEPOSITIONENVIRONMENT'
        OnTitleClick = IWDBGrid1Columns0TitleClick
        Title.Alignment = taCenter
        Title.BGColor = clNone
        Title.DoSubmitValidation = True
        ...
        Title.Height = '0'
        Title.ShowHint = True
        Title.Text = 'Sedimentary Environment'
        Title.VAlign = vaMiddle
        Title.Visible = True
        Title.Width = '0'
        Title.Wrap = False
    ...
    DataSource = dmStrat.dsSedEnvironments
    FooterRowCount = 0
    FriendlyName = 'iwDBg'
    FromStart = False
  ...
  object FDMemTable1: TFDMemTable
    ...
    Left = 488
    Top = 72
    object FDMemTable1DepositionEnvironmentID: TStringField
      FieldName = 'DepositionEnvironmentID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Size = 1
    end
    object FDMemTable1DepositionEnvironment: TStringField
