object ISFClanTypes: TISFClanTypes
  Left = 0
  Top = 0
  Width = 800
  Height = 598
  ...
  object FDMemTable1: TFDMemTable
    ...
    Left = 568
    Top = 120
    object FDMemTable1ClanTypeID: TIntegerField
      FieldName = 'ClanTypeID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
    end
    object FDMemTable1ClanType: TStringField
      FieldName = 'ClanType'
      Size = 50
    end
  end
