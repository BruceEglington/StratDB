...
uses
  ...
  IWStrat_addlipmorphologylink, IWStrat_lips;
...
begin
  ...
  iwbReturn.Visible := (dmLIP.cdsLIPQ.State in [dsBrowse]);
...
begin
  ...
  dmDV.cdsQueryDV.Close;
  dmDV.cdsDVMinMax.Close;
  //dmUser.SetDeveloperData('Returning from LIPDetails');
  //dmUser.SetDeveloperData('UnitSender is '+UserSession.UnitSender);
  UserSession.LastVisitedForm := TIWAppFormClass(WebApplication.ActiveForm.ClassType);
  TIWAppForm(WebApplication.ActiveForm).Release;
  if (UserSession.UnitSender = 'NewLIP') then
  begin
...
begin
  ...
  //dmUser.SetDeveloperData('Creating LIPDetails');
  //dmUser.SetDeveloperData('UnitSender is '+UserSession.UnitSender);
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      dmLIP.cdsValidFullDATEDONE.AsDateTime := dmUser.GetUTCDateTime;
...
begin
  ...
  begin
    try
      ...
      dmDV.qDVMinMax.SQL.Add('AND USERSWHOFOR.USERID=:UserID');
...
begin
  ...
  begin
    ...
    begin
      ...
      dmLIP.cdsLIPValidDATEDONE.AsDateTime := dmUser.GetUTCDateTime;
