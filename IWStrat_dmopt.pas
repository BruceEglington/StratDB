...
type
  TdmOpt = class(TDataModule)
    ...
    qOptLINKTODATEVIEW: TWideStringField;
    cdsOptUSERID: TWideStringField;
    cdsOptLINKTODATEVIEW: TWideStringField;
    qOptAll: TSQLQuery;
    ...
    qOptAllLINKTODATEVIEW: TWideStringField;
    qOptAllINCLUDESEAMS: TWideStringField;
    qOptINCLUDESEAMS: TWideStringField;
    cdsOptINCLUDESEAMS: TWideStringField;
    cdsOptAllUSERID: TWideStringField;
    cdsOptAllLINKTODATEVIEW: TWideStringField;
    cdsOptAllINCLUDESEAMS: TWideStringField;
    ...
    qUserForWHOFORID: TWideStringField;
    qUserForUSERID: TWideStringField;
    cdsUserForWHOFORID: TWideStringField;
    cdsUserForUSERID: TWideStringField;
    qUserForWHOFOR: TWideStringField;
...
uses
  IWInit,
  ServerController, usrIW_dm, UserSessionUnit;
