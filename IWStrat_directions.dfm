object ISFDirections: TISFDirections
  Left = 0
  Top = 0
  Width = 687
  Height = 598
  ...
  object iwDBg: TIWDBGrid
    ...
    DataSource = dmStrat.dsDirections
    FooterRowCount = 0
    FriendlyName = 'iwDBg'
    FromStart = False
  ...
  object FDMemTable1: TFDMemTable
    ...
    Left = 568
    Top = 72
    object FDMemTable1DirectionAngle: TIntegerField
      FieldName = 'DirectionAngle'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
    end
    object FDMemTable1DirectionName: TStringField
      FieldName = 'DirectionName'
      Size = 50
    end
    object FDMemTable1SourcedFrom: TStringField
