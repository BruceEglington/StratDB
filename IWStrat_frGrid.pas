...
uses
  ...
  IWStrat_uMain, IWStrat_constants, usrIW_dm, UserSessionUnit;
...
begin
  ...
  begin
    ...
    iwDBgResults.DataSource := dmStrat.dsQuery1;
...
begin
  ...
  dmStrat.qRep5.ParamByName('USERID').AsString := tmpUser;
  ...
  try
    ...
    fr.AddTable('cdsRep5',dmStrat.cdsRep5);
