object ISFGridGrainProbabilityUnits: TISFGridGrainProbabilityUnits
  ...
  object iwrPageFull: TIWRegion
    ...
    object iwrGraph: TIWRegion
      ...
      BorderOptions.Color = clNone
      ExplicitTop = 2247
      object iwrGraphGraph: TIWRegion
        Left = 0
        Top = 0
        Width = 991
        Height = 700
        ...
        object ChartPDF: TChart
          ...
          LeftAxis.Title.Caption = 'Unit Age (Ma)'
      ...
      object iwrGraphDownload: TIWRegion
        Left = 0
        Top = 700
        Width = 991
        Height = 101
        ...
        object iwbDownloadGrainCurves: TIWButton
          ...
          Width = 222
          Height = 25
          Caption = 'Download Curves to Excel'
          Enabled = False
          Color = clBtnFace
          Font.Color = clNone
          Font.Size = 9
    ...
    object iwrGraphOptions: TIWRegion
      ...
      object iwcbPDFAutoscale: TIWCheckBox
        Left = 505
        Top = 288
        Width = 136
        Height = 21
        ...
        Style = stNormal
        TabOrder = 25
        OnClick = iwcbPDFAutoscaleClick
        OnChange = iwcbPDFAutoscaleChange
        Checked = True
        FriendlyName = 'iwcbPDFAutoscale'
      end
