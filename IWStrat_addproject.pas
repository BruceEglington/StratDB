...
uses
  ServerController, IWStrat_dm, usrIW_dm, IWStrat_uMain, IWStrat_dmDV;
...
var
  tUserID, tUserProjectName : string;
...
begin
  ...
  begin
    //try
      tUserID := dmStrat.cdsUserProjectsUSERID.AsString;
      tUserProjectName := dmStrat.cdsUserProjectsUSERPROJECTNAME.AsString;
      tUserProjectID := dmStrat.cdsUserProjectsUSERPROJECTID.AsInteger;
      ...
      dmDV.InsertUserProject(tUserProjectID,tUserID,tUserProjectName,WasSuccessful);
    //except
      //
    //end;
