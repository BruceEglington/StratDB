object ISFRanks: TISFRanks
  ...
  object FDMemTable1: TFDMemTable
    ...
    Left = 672
    Top = 160
    object FDMemTable1RankID: TStringField
      FieldName = 'RankID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Size = 5
    end
    object FDMemTable1RankWidth: TIntegerField
      FieldName = 'RankWidth'
    end
    object FDMemTable1Rank: TStringField
      FieldName = 'Rank'
      Size = 50
    end
  end
