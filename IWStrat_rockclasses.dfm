object ISFRockClasses: TISFRockClasses
  Left = 0
  Top = 0
  Width = 800
  Height = 598
  ...
  object iwDBg: TIWDBGrid
    ...
    DataSource = dmStrat.dsRockClasses
    FooterRowCount = 0
    FriendlyName = 'iwDBg'
    FromStart = False
  ...
  object FDMemTable1: TFDMemTable
    ...
    Left = 688
    Top = 184
    object FDMemTable1RockClassID: TStringField
      FieldName = 'RockClassID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Size = 2
    end
    object FDMemTable1RockClass: TStringField
      FieldName = 'RockClass'
      Size = 50
    end
  end
